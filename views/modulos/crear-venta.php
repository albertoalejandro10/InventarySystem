        ...
        <div class="box-header with-border">
          <form role="form" action="" method="post" class="formularioVenta">
            ...
            <div class="box-footer">
              <a href="/ventas"><button type="button" class="btn btn-default pull-left" data-dismiss="modal"><i class="fa fa-sign-out"></i>&nbsp; Salir</button></a>
              <button type="submit" class="btn btn-primary pull-right"><i class="fa fa-plus"></i>&nbsp; Guardar servicio</button>
            </div>
          </form>
