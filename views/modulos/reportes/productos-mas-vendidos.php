...
<div class="box box-info">
    ...
    <h3 class="box-title"><strong>Productos más utilizados en servicios</strong></h3>
  </div>
	...
	<div class="box-body">
      	<div class="row">
		    ...
		    <div class="col-md-5">
		  	 	...
		  	 	<?php
            for ($i = 0; $i < 6; $i++) {
                echo ' <li><i class="fa fa-circle-o text-'.$colores[$i].'"></i> <strong>'.$productos[$i]["descripcion"].'</strong></li>';
            }
           ?>
		  	 	</ul>
		    </div>
